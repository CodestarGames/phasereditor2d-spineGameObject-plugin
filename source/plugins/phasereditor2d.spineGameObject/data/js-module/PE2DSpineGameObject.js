...
export default class PE2DSpineGameObject extends Phaser.GameObjects.RenderTexture {
    textureKey = '';
    animationName = '';
    loop:boolean = false;
    brush = null;
    ...
    redraw() {
        ...
        if (this.isFilled || this.isStroked) {
            ...
            if (this.shadowOffsetX !== 0 && this.shadowOffsetY !== 0 && this.shadowAlpha !== 0) {
                ...
                gr.fillRoundedRect(x + this.shadowOffsetX, y + this.shadowOffsetY, w, h, this.shadowRadius === -1 ? this.radius : this.shadowRadius);
            }
            if (this.isFilled) {
