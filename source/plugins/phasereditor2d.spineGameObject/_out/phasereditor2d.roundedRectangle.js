...
(function (phasereditor2d) {
    ...
    (function (spineGameObject) {
        ...
        spineGameObject.RoundedRectangleComponent = RoundedRectangleComponent;
    })(spineGameObject = phasereditor2d.spineGameObject || (phasereditor2d.spineGameObject = {}));
})(phasereditor2d || (phasereditor2d = {}));
var phasereditor2d;
(function (phasereditor2d) {
    ...
    (function (spineGameObject) {
        ...
        class RoundedRectangleEditorSupport extends sceneobjects.GameObjectEditorSupport {
            constructor(obj, scene) {
                super(spineGameObject.RoundedRectangleExtension.getInstance(), obj, scene);
                this.addComponent(new sceneobjects.TransformComponent(obj), new sceneobjects.OriginComponent(obj), new sceneobjects.VisibleComponent(obj), new sceneobjects.AlphaSingleComponent(obj), new sceneobjects.SizeComponent(obj), new spineGameObject.RoundedRectangleComponent(obj));
            }
            setInteractive() {
            ...
            computeContentHash() {
                return this.computeContentHashWithComponent(this.getObject(), spineGameObject.RoundedRectangleComponent);
            }
        }
        spineGameObject.RoundedRectangleEditorSupport = RoundedRectangleEditorSupport;
    })(spineGameObject = phasereditor2d.spineGameObject || (phasereditor2d.spineGameObject = {}));
})(phasereditor2d || (phasereditor2d = {}));
var phasereditor2d;
(function (phasereditor2d) {
    ...
    (function (spineGameObject) {
        class RoundedRectangleExtension extends phasereditor2d.scene.ui.sceneobjects.SceneGameObjectExtension {
            ...
            getBlockCellRenderer() {
                return spineGameObject.RoundedRectangleBlockCellRenderer.getInstance();
            }
            ...
            createGameObjectWithData(args) {
                const obj = new spineGameObject.RoundedRectangle(args.scene, 0, 0, 50, 50);
            ...
            getCodeDOMBuilder() {
                return new spineGameObject.RoundedRectangleCodeDOMBuilder();
            }
            createDefaultSceneObject(args) {
                const obj = new spineGameObject.RoundedRectangle(args.scene, args.x, args.y, 100, 100);
                obj.redraw();
                return [obj];
            }
        }
        spineGameObject.RoundedRectangleExtension = RoundedRectangleExtension;
    })(spineGameObject = phasereditor2d.spineGameObject || (phasereditor2d.spineGameObject = {}));
})(phasereditor2d || (phasereditor2d = {}));
var phasereditor2d;
(function (phasereditor2d) {
    ...
    (function (spineGameObject) {
        ...
        spineGameObject.CMD_CREATE_ROUNDED_USER_FILES = "phasereditor2d.spineGameObject.CreateRoundedRectangleUserFiles";
        class RoundedRectanglePlugin extends colibri.Plugin {
            ...
            registerExtensions(reg) {
                reg.addExtension(spineGameObject.RoundedRectangleExtension.getInstance());
                reg.addExtension(new phasereditor2d.scene.ui.editor.properties.SceneEditorPropertySectionExtension(page => new spineGameObject.RoundedRectangleSection(page)));
                reg.addExtension(new colibri.ui.ide.PluginResourceLoaderExtension(() => spineGameObject.RoundedRectangleCodeResources.getInstance().preload()));
                reg.addExtension(new colibri.ui.ide.commands.CommandExtension(manager => {
                    ...
                    for (const spec of ["js", "js-module", "ts", "ts-module"]) {
                        manager.add({
                            ...
                            handler: {
                                executeFunc: args => {
                                    spineGameObject.RoundedRectangleCodeResources.getInstance().createFiles(spec);
                                }
                            }
                        });
                    }
        ...
        spinegameobject.RoundedRectanglePlugin = RoundedRectanglePlugin;
...
(function (phasereditor2d) {
    ...
    (function (spinegameobject) {
        class RoundedRectangleSection extends phasereditor2d.scene.ui.sceneobjects.SceneGameObjectSection {
            constructor(page) {
                super(page, RoundedRectangleSection.SECTION_ID, "Spine Game Object", false, false);
            }
            createForm(parent) {
                const comp = this.createGridElement(parent);
                comp.style.gridTemplateColumns = "auto auto 1fr auto";
                this.createPropertyFloatRow(comp, spinegameobject.RoundedRectangleComponent.radius)
                    .style.gridColumn = "3 / span 2";
                this.createPropertyBoolean(comp, spinegameobject.RoundedRectangleComponent.isFilled)
                    .checkElement.style.gridColumn = "3 / span 2";
                this.createPropertyColorRow(comp, spinegameobject.RoundedRectangleComponent.fillColor, false)
                    .element.style.gridColumn = "3 / span 2";
                this.createPropertyFloatRow(comp, spinegameobject.RoundedRectangleComponent.fillAlpha)
                    .style.gridColumn = "3 / span 2";
                this.createPropertyBoolean(comp, spinegameobject.RoundedRectangleComponent.isStroked)
                    .checkElement.style.gridColumn = "3 / span 2";
                this.createPropertyColorRow(comp, spinegameobject.RoundedRectangleComponent.strokeColor, false)
                    .element.style.gridColumn = "3 / span 2";
                this.createPropertyFloatRow(comp, spinegameobject.RoundedRectangleComponent.strokeAlpha)
                    .style.gridColumn = "3 / span 2";
                this.createPropertyFloatRow(comp, spinegameobject.RoundedRectangleComponent.lineWidth)
                    .style.gridColumn = "3 / span 2";
                this.createPropertyFloatRow(comp, spinegameobject.RoundedRectangleComponent.shadowOffsetX)
                    .style.gridColumn = "3 / span 2";
                this.createPropertyFloatRow(comp, spinegameobject.RoundedRectangleComponent.shadowOffsetY)
                    .style.gridColumn = "3 / span 2";
                this.createPropertyFloatRow(comp, spinegameobject.RoundedRectangleComponent.shadowRadius)
                    .style.gridColumn = "3 / span 2";
                this.createPropertyColorRow(comp, spinegameobject.RoundedRectangleComponent.shadowColor, false)
                    .element.style.gridColumn = "3 / span 2";
                this.createPropertyFloatRow(comp, spinegameobject.RoundedRectangleComponent.shadowAlpha)
                    .style.gridColumn = "3 / span 2";
            }
            canEdit(obj, n) {
                return obj instanceof spinegameobject.RoundedRectangle;
            }
            canEditNumber(n) {
                return n > 0;
            }
        }
        RoundedRectangleSection.SECTION_ID = "phasereditor2d.spineGameObject.RoundedRectangleSection";
        spinegameobject.RoundedRectangleSection = RoundedRectangleSection;
    })(spinegameobject = phasereditor2d.spinegameobject || (phasereditor2d.spinegameobject = {}));
})(phasereditor2d || (phasereditor2d = {}));
