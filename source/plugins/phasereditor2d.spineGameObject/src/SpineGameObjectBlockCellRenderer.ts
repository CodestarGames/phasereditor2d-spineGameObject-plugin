...
namespace phasereditor2d.spineGameObject {
    ...
    export class SpineGameObjectBlockCellRenderer extends scene.ui.sceneobjects.ShapeBlockCellRenderer {

        static _instance: SpineGameObjectBlockCellRenderer;
        ...
        protected renderShapeCell(ctx: CanvasRenderingContext2D, args: controls.viewers.RenderCellArgs) {
            ...
            ctx.beginPath();
            SpineGameObjectBlockCellRenderer.drawSpineGameObject(ctx, x, y, size, size, r, r, r, r);
            ctx.stroke();
        }

        static drawSpineGameObject(
